local config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
        callback = function(event)
            ...
            -- When you move the cursor, the highlights will be cleared (the second autocommand).
            ...
            -- code, if the language server supports them
    ...
    --  When is added nvim-cmp, luasnip, etc. Neovim now has *more* capabilities.
